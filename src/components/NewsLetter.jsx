...
const NewsLetter = () => {
  return (
      <div className="flex flex-col items-center max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
          ...
          <Title title='Stay Notified!' subTitle='Join our newsletter to  be the first one to receive exclusive offers, updates, and the latest news from our assosciated hotels.' align='center' font='font-playfair' />
