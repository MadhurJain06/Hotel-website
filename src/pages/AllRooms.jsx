        ...
        <div>
            <div className='flex flex-col items-start text-left mb-8'> 
                <h1 className='font-playfair text-4xl md:text-[40px]'>Hotel Rooms</h1>
                  <p className='text-sm md:text-base text-gray-500/90 mt-2 max-w-174'> Explore the luxurious amenities and services that await you in the exquisite rooms. From plush bedding to modern conveniences, every detail has been meticulously designed to ensure your comfort and satisfaction. </p>

            </div>
            {roomsDummyData.map((room)=>(
                <div className='flex flex-col md:flex-row gap-6 items-start  py-10 border-b border-gray-300 last:pb-30 last-border-0' key={room._id}>
                ...
                <div className='md:w-1/2 flex flex-col gap-2'>
                    ...
                    {/* pRICE */}
                    <p className='text-xl font-medium text-gray-700'> <span className='text-xs text-gray-700/60'>1 night</span> ${room.pricePerNight} </p>
                </div>
                </div>
            ))}
        </div>
