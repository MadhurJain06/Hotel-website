...
const ListRoom = () => {
  ...
  return (
    <div>
        <Title align='left' font='outfit' title='Room Listings' subTitle='View, edit or manage all the rooms listed. Keep the info upto date to provide the best experience for users.' />
        <p className='text-gray-600 mt-5'>All rooms</p>
